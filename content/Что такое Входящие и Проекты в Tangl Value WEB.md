...
После [[Начало работы с Tangl Value|открытия программы]], вы окажетесь на **главной странице**.
В левом верхнем углу основные элементы - *Входящие* и *Проекты*
> **Входящие** – это все <u>BIM-модели</u>, загруженные в Tangl. Вы можете просмотривать их отдельно, объединять в жилые комплексы, смотреть свойства элементов и многое другое. Большинство моделей разработано ИКП, часть создана другими проектировщиками, но все они предназначены для Атомстройкомплекс.

> **Проекты** – это все <u>способ организовать BIM-модели</u> в удобной структуре. Помимо ВОР, там хранятся и другие сведения о BIM-моделях: постатейные бюджеты для стадии П, данные для эксплуатации и многое другое. В Tangl они называются результаты анализа.
## 2.1. Входящие
